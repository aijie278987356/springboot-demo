package org.aijie.email.service;

import cn.hutool.core.io.resource.ResourceUtil;
import org.aijie.email.SpringbootDemoEmailApplicationTests;
...
public class MailServiceTest extends SpringbootDemoEmailApplicationTests {
    ...
    public void sendAttachmentsMail() throws MessagingException {
        ...
        mailService.sendAttachmentsMail("278987356@qq.com", "这是一封带附件的邮件", "邮件中有附件，请注意查收！", resource.getPath());
    }
    ...
    public void sendResourceMail() throws MessagingException {
        ...
        URL resource = ResourceUtil.getResource("static/xkcoding.png");
        mailService.sendResourceMail("278987356@qq.com", "这是一封带静态资源的邮件", content, resource.getPath(), rscId);
    }
}
